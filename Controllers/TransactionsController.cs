...
public class TransactionsController : Controller
{
    ...
    {
        var all = _finance.GetTransactions(UserId);
        ...
        {
            CurrentUser    = _users.GetById(UserId)!,
            Transactions   = all,
        ...
        string description, string icon, DateTime date)
    {
        ...
        _finance.AddTransaction(UserId,
    ...
    {
        var t = _finance.GetTransaction(id);
    ...
    {
        var t = _finance.GetTransaction(id);
        if (t != null && t.UserId == UserId) _finance.DeleteTransaction(id);
